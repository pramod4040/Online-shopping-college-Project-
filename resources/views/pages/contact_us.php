...
<?php view('layouts/header') ?>	
			...
			<!-- AIzaSyCllnEcO-gwXdbh1RhPF1i2taQ3U8X5FyM -->
			<section class="main-content">				
				<div class="row">				
					<div class="span5">
						<div>
							<h5>ADDITIONAL INFORMATION</h5>
							<p><strong>Phone:</strong>&nbsp;(+977) 9860260878<br>
							<strong>Fax:</strong>&nbsp;+04 (123) 456-7890<br>
							<strong>Email:</strong>&nbsp;<a href="#">bhajakopasal@gmail.com</a>								
							</p>
							<br/>
							<h5>SECONDARY OFFICE IN Jhapa</h5>
							<p><strong>Phone:</strong>&nbsp;(+977) 9814961565<br>
							<strong>Fax:</strong>&nbsp;+04 (113) 023-1145<br>
							<strong>Email:</strong>&nbsp;<a href="#">bhajakopasal_jhapa@gmail.com</a>					
							</p>
						</div>
					</div>
					<div class="span7">
