						...
						<ul class="thumbnails listing-products">
							...
							<li class="span3">
								<div class="product-box">
									...
									<a href="/category/detail/<?php echo $item['cid']; ?>" class="category"><?php echo $item['ctitle']  ?></a>
								...
								<div class="carousel-inner">
									...
									<div class="active item">
										<ul class="thumbnails listing-products">
											...
											<li class="span3">
												<div class="product-box">
													<span class="sale_tag"></span>												
													<img alt="" src="<?php echo $random[0]['image'] ?>"><br/>
									...
									<div class="item">
										<ul class="thumbnails listing-products">
											<li class="span3">
												<div class="product-box">												
													<img alt="" src="<?php echo $random[$i]['image'] ?>"><br/>
							...
							<ul class="small-product">
								...
								<?php } ?>
									...
									<a href="#" title="Luctus quam ultrices rutrum">
										<img src="/assets/user/themes/images/ladies/4.jpg" alt="Luctus quam ultrices rutrum">
									</a>
									<a href="#">Luctus quam ultrices rutrum</a>
								</li>
								<li>
									<a href="#" title="Fusce id molestie massa">
										<img src="/assets/user/themes/images/ladies/5.jpg" alt="Fusce id molestie massa">
									</a>
